                        ...
                        <View style={styles.section_container}>
                            <View style={styles.toggleSwitch} >
                                <ToggleSwitch
                                    ...
                                    size="medium"
                                    onToggle={() => (this.state.darkMode) ? this.setState({ darkMode: false }) : this.setState({ darkMode: true })}
                                />
                            </View>
                            <View style={styles.toggleSwitch}>
                                <ToggleSwitch
                                    ...
                                    size="medium"
                                    onToggle={() => (this.state.notification) ? this.setState({ notification: false }) : this.setState({ notification: true })}
                                />
                            </View>
                        </View>
                    </View>
